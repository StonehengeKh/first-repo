//Blog Page Pop Up
			...
			function centerPopupBlog(){
				...
				var popupBlogHeight = $("#popupBlog-2").height();
				var popupBlogWidth = $("#popupBlog-2").width();
				$("#popupBlog-2").css({
					"position": "fixed",
					"top": windowHeight/1.5-popupBlogHeight/1.5,
			...
			$(document).ready(function(){
				...
				$("#popupBlog-2").css({
					...
					centerPopupBlog();
					loadPopupBlog();
				    $("#popupBlog-2").mCustomScrollbar("vertical",400,"easeOutCirc",1.05,"auto","yes","yes",10);						
				});
